...
-- Load Nord theme with configuration options
require('nord').set()
...
vim.g.nord_contrast = true       -- Enable contrast for sidebar and non-current windows
vim.g.nord_borders = true        -- Enable borders for windows
vim.g.nord_italic = false        -- Enable italic comments
...
-- Custom key mappings (in init.lua)
